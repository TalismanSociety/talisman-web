...
const SvgUnknown = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 11 16" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
    <path
