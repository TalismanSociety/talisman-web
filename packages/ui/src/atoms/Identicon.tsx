...
import { display as asCssColor, HSL, HSV, to as toColorSpace } from 'colorjs.io/fn'
import md5 from 'md5'
...
export const Identicon = ({ value: seed, size = '2.4rem', className, style }: IdenticonProps) => {
  const id = useId()
