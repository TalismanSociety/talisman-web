...
import { resolveValue, toast as toaster } from 'react-hot-toast/headless'

import { CircularProgressIndicator } from '../atoms/CircularProgressIndicator'
import { SurfaceIconButton } from '../atoms/IconButton'
import { useSurfaceColor } from '../atoms/Surface'
...
export const ToastBar = ({ toast }: ToastBarProps) => {
