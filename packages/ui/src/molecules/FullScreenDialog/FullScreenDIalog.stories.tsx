...
import FullScreenDialog, { FullScreenDialogProps, FullScreenDialogQuarterSelector } from './FullScreenDialog'
...
Default.args = {
  ...
  title: 'Unstake',
  children: (
    <div css={{ [`${FullScreenDialogQuarterSelector}`]: { minWidth: 412 } }}>
