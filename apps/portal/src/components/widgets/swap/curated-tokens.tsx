export const popularTokens: string[] = [
  ...
  '169-evm-native', // ETH on Manta Pacific
  '169-evm-erc20-0x95cef13441be50d20ca4558cc0a27b601ac544e5', // MANTA on Manta Pacific
...
export const talismanTokens: string[] = [
  '146-evm-native', // S on Sonic
  'analog-timechain-substrate-native', // ANLOG on Analog
  'astar-substrate-native', // ASTR on Astar
  '1-evm-erc20-0xb59490ab09a0f526cc7305822ac65f2ab12f9723', // Old LIT on Eth
  'aleph-zero-substrate-native', // AZERO on Aleph Zero
  'kusama-substrate-native', // KSM on Kusama
  '1-evm-erc20-0xba41ddf06b7ffd89d1267b5a93bfef2424eb2003', // MYTH on Eth
  'acala-substrate-native', // ACA on Acala
  '1-evm-erc20-0x2da719db753dfa10a62e140f436e1d67f2ddb0d6', // CERE on Eth
  '1284-evm-native', // GLMR on Moonbeam
  '1285-evm-native', // MOVR on Moonriver
  'avail-substrate-native', // AVAIL on Avail
  '1-evm-erc20-0xaa7a9ca87d3694b5755f213b5d04094b8d0f0a6f', // TRAC on Eth
  '1-evm-erc20-0xc221b7e65ffc80de234bbb6667abdd46593d34f0', // WCFG on Eth
  'moonbeam-substrate-native', // GLMR on Moonbeam
  'moonriver-substrate-native', // MOVR on Moonriver
]
