...
import type { ExtrinsicDetailsSideSheetProps } from '@/components/recipes/ExtrinsicDetailsSideSheet'
import type { Account } from '@/domains/accounts'
import { ExtrinsicDetailsSideSheet } from '@/components/recipes/ExtrinsicDetailsSideSheet'
