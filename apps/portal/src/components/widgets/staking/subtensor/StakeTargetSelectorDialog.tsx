...
export const StakeTargetSelectorDialog = (props: StakeTargetSelectorDialogProps) => {
...
StakeTargetSelectorDialog.Item = StakeTargetSelectorItem

export const DelegateSelectorDialog = (
  props: Omit<
...
DelegateSelectorDialog.Item = DelegateSelectorItem
